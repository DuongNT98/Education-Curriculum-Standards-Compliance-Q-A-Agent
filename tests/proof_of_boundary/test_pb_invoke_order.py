...
# S-4 node_complete, for every concrete node under src/nodes/. Also verifies
# an under-privileged caller is denied at S-1 before execute() or normal
# lifecycle events can run (TC-08).
